...
async function createDotnetVue(CURR_DIR, projectName) {
  return new Promise(async (resolve, reject) => {
    try {
      let projPath = `${CURR_DIR}/${projectName}`
      addHerokuDeployWorkflow(CURR_DIR, projectName)
...
function addHerokuDeployWorkflow(CURR_DIR, projectName) {
  fs.mkdirSync(`${CURR_DIR}/.github/workflows`)
  fs.writeFileSync('deploy.yml', `# Deploy Dotnet to Heroku.
